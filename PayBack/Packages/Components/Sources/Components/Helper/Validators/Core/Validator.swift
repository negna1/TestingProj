...
public class Validator {
    ...
    public var errors = ValidatorDictionary<ValidateError>()
    ...
    private var errorStyleTransform:((_ validationError:ValidateError)->Void)?
    ...
    */
    private func validateAllFields() {
        ...
        errors = ValidatorDictionary<ValidateError>()
    ...
    - returns: No return value.
    */
    public func validateField(_ field: ValidatableField, callback: (_ error:ValidateError?) -> Void){
    ...
    - returns: No return value
    */
    public func styleTransformers(success:((_ validationRule:ValidationRule)->Void)?, error:((_ validationError:ValidateError)->Void)?) {
    ...
    /**
     ...
     - returns: No return value.
     */
    public func validate(_ callback:(_ errors:[(Validatable, ValidateError)])->Void) -> Void {
